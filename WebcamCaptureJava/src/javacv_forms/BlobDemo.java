...
public class BlobDemo
{
    ...
    public static void demo()
    {
        ...
        for(int k = 0; k < 7; k++)
        {
					 ...
					 //ShowImage(RawImage, "RawImage", 512);
					 		case 1:
								 RawImage = cvLoadImage("Shapes1.jpg");
								 MinArea = 6;
								 ErodeCount = 0;
								 DilateCount = 1;
								 break;
					 		case 2:
								 RawImage = cvLoadImage("Shapes2.jpg");
								 MinArea = 250;
								 ErodeCount = 0;
								 DilateCount = 1;
								 break;
					 		case 3:
								 RawImage = cvLoadImage("Blob1.jpg");
								 MinArea = 2800;
								 ErodeCount = 1;
								 DilateCount = 1;
								 break;
					 		case 4:
								 RawImage = cvLoadImage("Blob2.jpg");
								 MinArea = 2800;
								 ErodeCount = 1;
								 DilateCount = 1;
								 break;
					 		case 5:
								 RawImage = cvLoadImage("Blob3.jpg");
								 MinArea = 2800;
								 ErodeCount = 1;
								 DilateCount = 1;
								 break;
            ...
            Blobs Regions = new Blobs();
					 int BlobAnalysis; // minarea
					 BlobAnalysis = Regions.ColorA
				(
									 WorkingImage,               // image
    ...
    public static void PrintImageProperties(IplImage image)
    {
        ...
        int rows = mat.rows();
        int depth = mat.depth();
        System.out.println("ImageProperties for " + Arrays.toString(image) + " : cols=" + cols + " rows=" + rows + " depth=" + depth);
    }
